...
export enum ValidationErrors {
  ...
  ADDITIONAL_INFORMATION_INVALID_CHARACTERS = "Additional information contains invalid characters. Only the character set defined by the Swiss Payment Standards (Version 2.3) is permitted.",
  ...
  CREDITOR_ADDRESS_INVALID_CHARACTERS = "Creditor address contains invalid characters. Only the character set defined by the Swiss Payment Standards (Version 2.3) is permitted.",
  ...
  CREDITOR_CITY_INVALID_CHARACTERS = "Creditor city contains invalid characters. Only the character set defined by the Swiss Payment Standards (Version 2.3) is permitted.",
  ...
  CREDITOR_NAME_INVALID_CHARACTERS = "Creditor name contains invalid characters. Only the character set defined by the Swiss Payment Standards (Version 2.3) is permitted.",
  ...
  DEBTOR_ADDRESS_INVALID_CHARACTERS = "Debtor address contains invalid characters. Only the character set defined by the Swiss Payment Standards (Version 2.3) is permitted.",
  ...
  DEBTOR_CITY_INVALID_CHARACTERS = "Debtor city contains invalid characters. Only the character set defined by the Swiss Payment Standards (Version 2.3) is permitted.",
  ...
  DEBTOR_NAME_INVALID_CHARACTERS = "Debtor name contains invalid characters. Only the character set defined by the Swiss Payment Standards (Version 2.3) is permitted.",
  ...
  MESSAGE_INVALID_CHARACTERS = "Message contains invalid characters. Only the character set defined by the Swiss Payment Standards (Version 2.3) is permitted.",
  ...
  QR_REFERENCE_LENGTH_IS_INVALID = "QR-Reference must be exactly 27 characters.",
