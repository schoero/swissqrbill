...
class PDF extends extended_pdf_1.default.PDF {
    ...
    _drawReceipt() {
        ...
        this.fontSize(8);
        this.font("Helvetica");
        this.text(`${(_a = this._formatIBAN(this._data.creditor.account)) !== null && _a !== void 0 ? _a : this._data.creditor.account}\n${this._formatAddress(this._data.creditor)}`, {
            width: this.mmToPoints(52)
        });
        this.moveDown();
        //-- Reference
    ...
    _generateQRCode() {
        ...
        //-- Create QR Code
        const qrcodeString = new qrcode_svg_1.default({
            content: qrString,
            join: true,
