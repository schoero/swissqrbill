...
class PDF extends extended_pdf_1.default.PDF {
    ...
    _generateQRCode() {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            //-- Create QR Code
            const qrcodeString = yield qrcode_1.default.toString(qrString, { type: "svg", width: utils.mmToPoints(46), margin: 0 }, (err, svg) => {
