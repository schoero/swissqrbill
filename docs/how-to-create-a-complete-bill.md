...
The [`SwissQRBill`][swissqrbill] class takes an object as a parameter containing the data for the QR bill. This information will usually be automatically by the program or retrieved from a database.
...
const qrBill = new SwissQRBill({/* QR bill data */});
